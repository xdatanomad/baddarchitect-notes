...
`content/notes/` contains raw source material, rough ideas, article seeds, research prompts, and unpolished thinking. Treat these files as source material, not publishable content.

## Current Files

- `website.md` - broad site framing and philosophical preamble.
- `bottlenecks.md` - major source essay for AI adoption constraints and production AI systems.
...
- Update this `AGENTS.md` whenever files are added, removed, renamed, or substantially repurposed in this directory.
